...
public class AjaxValidation
{
    ...
    protected Object validation()
    {
        ...
        resources.triggerEvent(TapesTwitterEventConstants.AJAX_VALIDATE, new Object[]
        { value }, callback);
    ...
    private void writeMessage(MarkupWriter writer, EnumValidation enumValue, String clientId)
    {
        ...
        String message = ValidationUtils.getLabel(clientId, enumValue, resources.getPage().getComponentResources().getMessages());
