...
public class DataSetLoaderServiceImpl implements DataSetLoaderService
{
    ...
    boolean productionMode)
    {
        ...
        try
        {
            ...
            tweetManager.createTweetFromUser(userLaurent, "Test 3");
            tweetManager.createTweetFromUser(userLaurent, "Test 4");
            tweetManager.createTweetFromUser(userLaurent, "Test 5");
            tweetManager.createTweetFromUser(userLaurent, "Test 6");
